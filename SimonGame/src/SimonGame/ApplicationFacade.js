...
puremvc.define(
    //class info
    {
        name: "SimonGame.ApplicationFacade",
    ...
    //instance member
    {
        ...
        startup: function () {
            if (!this.initialized) {
                ...
                this.registerCommand(AppConstants.STARTUP_COMMAND, SimonGame.controller.StartupCommand);
    ...
    // STATIC MEMBERS
    {
        ...
        getInstance: function (multitonKey) {
            ...
            return instanceMap[multitonKey] = new SimonGame.ApplicationFacade(multitonKey);
        },

        NAME: 'SimonGame_GameTemplate'
    }
)
